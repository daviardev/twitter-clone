...
import { HiDotsHorizontal, HiOutlineChartBar, HiSwitchHorizontal } from 'react-icons/hi'
...
const Posts = ({ id, post, postPage }) => {
  ...
  return (
    <>
      <div className='p-3 fkex cursor-pointer border-b border-gray-700 text-white'>
        {!postPage && (
          <img
            src={post?.userImg}
            alt='Image'
          ...
          <div className={`text-[#6e767d] flex justify-between w-10/12 ${postPage && 'mx-auto'}`}>
            ...
            >
              <div className='icon group-hover:bg-[#1d9bf0] group-hover:bg-opacity-10'>
                <HiChat className='h-5 group-hover:text-[#1d9bf0]' />
              </div>
              {comments.length > 0 && (
